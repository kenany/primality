...
if(0===a%(c+12))return c+12;if(0===a%(c+16))return c+16;if(0===a%(c+22))return c+22;if(0===a%(c+24))return c+24}return a}function e(a){return m.isNaN(a)||!m.isFinite(a)||a%1||a<2?!1:a!==d(a)?!1:!0}function f(a,b,c){return Math.abs(a-b)!==c?!1:q([a,b])}function g(a,b){return f(a,b,2)}function h(a,b){return f(a,b,4)}function i(a,b){return f(a,b,6)}function j(a){return m.contains(o,a)?!0:0===(l(a-1)+1)%Math.pow(a,2)}function k(a){return m.contains(p,a)?!0:0===(Math.pow(2,a-1)-1)%Math.pow(a,2)}var l=b("factorial"),m={};
try{m.contains=b("lodash.contains"),m.isArray=b("lodash.isarray"),m.isFinite=b("lodash.isfinite"),m.isNaN=b("lodash.isnan")}catch(n){m.contains=b("contains"),m.isArray=b("isArray"),m.isFinite=b("is-finite"),m.isNaN=b("is-nan")}var o=[5,13,563],p=[1093,3511],q=function(a){if(null===a||""===a)return null;if(m.isArray(a)){for(var b=a.length;b--;)if(!e(a[b]))return!1;return!0}return e(a)};q.VERSION="1.6.0",q.areTwinPrimes=g,q.areCousinPrimes=h,q.areSexyPrimes=i,q.isWilsonPrime=j,q.isWieferichPrime=k,(c.exports=q).primality=q
